...
to do this before you import your model, e.g.::
    ...
    from proteomeapp.model import YourModelClass, User, ...
...
try:
    from proteomeapp.model import User, create_tables, create_default_user
except ImportError:
    import warnings
...
def _create_test_user():
    obj = User(user_name=u"creosote", email_address=u"spam@python.not",
        display_name=u"Mr Creosote", password=u"Wafer-thin Mint")
    return obj
