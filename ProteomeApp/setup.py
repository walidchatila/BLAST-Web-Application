...
execfile(os.path.join("proteomeapp", "release.py"))

packages = find_packages()
package_data = find_package_data(where='proteomeapp',
    package='proteomeapp')
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'start-proteomeapp = proteomeapp.command:start',
            # See the proteomeapp.command.bootstrap function for details
